...
def update_patient(patient_id:str,patient_update:PatientUpdate):
    ...
    for key, value in updated_patient_info.items(): # jo value set krke bheji gyi hai vhi ayegi
        existing_patient_info[key] = value
    
    # existing_patient_info -> pydantic obejct -> updated bmi + verdict
    existing_patient_info['id'] = patient_id
    patient_pydatic_object = Patient(**existing_patient_info)
    
    # pydantic object -> dict
    existing_patient_info = patient_pydatic_object.model_dump(exclude=['id'])
